...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DMWSzjb2.js
...
var styles_default = "/assets/styles-D92hUwtg.css";
var APP_NAME = "Umanga Rimal";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{ title: `${APP_NAME} — Photography · Cinematography` },
			{
				name: "description",
				content: "Umanga Rimal — a young creative from Nepal working across photography, cinematography, visual design and web development."
			},
			{
				name: "theme-color",
				content: "#0a0908"
...
var $$splitComponentImporter = () => import("./routes-BO-79rNs.mjs").then((n) => n.t);
